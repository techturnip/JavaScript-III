...
const GameObject = function(props) {
...
const CharacterStats = function(childProps) {
  GameObject.call(this, childProps);
  this.healthPoints = childProps.healthPoints;
};
...
const Humanoid = function(grandChildProps) {
  CharacterStats.call(this, grandChildProps);
  this.team = grandChildProps.team;
  this.weapons = grandChildProps.weapons;
  this.language = grandChildProps.language;
};
...
const Villain = function(villainProps) {
  ...
  this.villain = villainProps.villain;
};
...
const evilDude = new Villain({
  ...
  team: 'The Villains',
  weapons: ['Evil Sword'],
  language: 'Evil Tongue'
});

console.log(evilDude.villainAttack(superDude));
console.log(superDude.heroAttack(evilDude));
console.log(evilDude.villainAttack(superDude));
console.log(superDude.heroAttack(evilDude));
console.log(evilDude.villainAttack(superDude));
console.log(superDude.heroAttack(evilDude));
